...
<body>
    ...
    <form method="post" action="<?php echo site_url('welcome/edit_mata_kuliah/' . $mata_kuliah->id); ?>">
        <!-- Mata Kuliah Input -->
        <label for="mata_kuliah">Mata Kuliah:</label>
        <input type="text" name="mata_kuliah" value="<?php echo htmlspecialchars($mata_kuliah->mata_kuliah); ?>" required>
        <br>

        <button type="submit">Simpan</button>
    </form>

    <a href="<?php echo site_url('welcome/view_mata_kuliah'); ?>">Kembali</a>
